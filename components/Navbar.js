  ...
  return (
    <nav className='bg-gray-900 text-white flex justify-between px-4 md:h-16 items-center flex-col md:flex-row'>
      <div >
        ...
        <img className='invertImg' width={44} src="/tea.webp" alt="" />
        <span className='text-3xl md:text-base my-5 md:my-0'>GetMeaChai!</span>
        </Link>
      </div>
